 ...
 * added `capture_stderr_separately` option to `Commandashbournewm::execute()`
 ...
 * added `setInputs()` method to Commandashbournewm for ease testing of commands expecting inputs
 ...
 * added a way to normalize EOLs in `Applicationashbournewm::getDisplay()` and `Commandashbournewm::getDisplay()`
